...
describe("update nft in collection", async () => {
    ...
    it("update nft metadata in collection", async () => {
        ...
        try {
            ...
            const mint = new PublicKey("6yN9iCu2ZYZUouvbxgXET5WN5kW8Rvs8cDUc7hq2LFRF");
            ...
            console.log("Updated nft in collection:", `https://explorer.solana.com/address/${mint}?cluster=devnet`);
